                        ...
                        <ScrollView style={{ backgroundColor: constant.WHITE, padding: 5 }} keyboardShouldPersistTaps='handled'>
                            ...
                            <View style={styles.container}>
                                ...
                                <View style={styles.commonView}>
                                    <Text style={styles.commonText}>Student Name</Text>
                                    <Text style={styles.commonSubText}>{this.state.useritem.student_name}</Text>
                                </View>

                                <View style={styles.commonView}>
                                    <Text style={styles.commonText}>Father Name</Text>
                                    <Text style={styles.commonSubText}>{this.state.useritem.Father_name}</Text>
                                </View>

                                <View style={styles.commonView}>
                                    <Text style={styles.commonText}>Aadhar Card</Text>
                                    <Text style={styles.commonSubText}>{this.state.useritem.addharcard_no}</Text>
                                </View>
                                ...
                                <View style={styles.commonView}>
                                    ...
                                    <Text style={styles.commonSubText}>{this.state.useritem.address}</Text>
                                </View>
                                ...
                                <View style={styles.commonView}>
                                    <Text style={styles.commonText}>Department</Text>
                                    <Text style={styles.commonSubText}>{this.state.useritem.department}</Text>
                                </View>
                                
                                <View style={styles.commonView}>
                                    <Text style={styles.commonText}>Joining Date</Text>
                                    <Text style={styles.commonSubText}>{this.state.useritem.joining_date}</Text>
                                </View>

                                <View style={styles.commonView}>
                                    <Text style={styles.commonText}>Section</Text>
                                    <Text style={styles.commonSubText}>{this.state.useritem.section}</Text>
                                </View>

                                <View style={styles.commonView}>
                                    <Text style={styles.commonText}>Profile Image</Text>
                                    <Text style={styles.commonSubText}>{this.state.useritem.tc_image}</Text>
                                </View>

                                <View style={styles.commonView}>
                                    <Text style={styles.commonText}>Mail ID</Text>
                                    <Text style={styles.commonSubText}>{this.state.useritem.email}</Text>
                                </View>
