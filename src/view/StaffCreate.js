...
class StaffCreate extends Component {
    ...
    onCreateApi() {
        ...
        var raw = JSON.stringify({
            "staff_name": this.state.samplename,
            "qualification": this.state.sampleType,
            "email": this.state.project,
            "phone": this.state.description,
            "profile_image": this.state.samplename + "Profile"
        });
        ...
        fetch("https://620502d5161670001741b2f7.mockapi.io/staff/staff", requestOptions)
            ...
            .then(result => this.props.navigation.navigate('StaffDetils'))
            ...
            <KeyboardAvoidingView
                ...
                <SafeAreaView style={{ flex: 1, backgroundColor: constant.WHITE }}>
                    ...
                    <LinearGradient style={styles.oval} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#1e6a78', '#1e6a78', '#1e6a78']}>
                        <TouchableOpacity
                            onPress={() =>
                                this.props.navigation.navigate('StaffDetils')
                            }>
                            <Image
                    ...
                    <View style={{ backgroundColor: 'transparent', flex: 1, }}>
                        <ScrollView style={{ backgroundColor: constant.WHITE, padding: 5 }} keyboardShouldPersistTaps='handled'>
                            <View style={styles.container}>
                                <Text style={{ alignSelf: 'center', fontSize: hp('2%'), fontWeight: 'bold', color: '#1e6a78' }}>Add Staff Details</Text>
