...
class StudentsCreate extends Component {
    ...
    onCreateApi() {
        ...
        var raw = JSON.stringify({
          "student_name": this.state.samplename,
          "Father_name": this.state.fathername,
          "Profile_image": "Profile_image 10",
          "email": this.state.email,
          "department": "department 10",
          "joining_date": this.state.joindate,
          "tc_image": "tc_image 10",
          "addharcard_no": this.state.aadhar,
        ...
        fetch("https://620502d5161670001741b2f7.mockapi.io/staff/student", requestOptions)
          .then(response => response.text())
          .then(result =>         this.props.navigation.navigate('StudentDetails'))
                    ...
                    <View style={{ backgroundColor: 'transparent', flex: 1, }}>
                        <ScrollView style={{ backgroundColor: constant.WHITE, padding: 5 }} keyboardShouldPersistTaps='handled'>
                            <View style={styles.container}>
                                <Text style={{ alignSelf: 'center', fontSize: hp('2%'), fontWeight: 'bold', color: '#1e6a78' }}>Add Student Details</Text>

                                <View style={styles.commonView}>
                                    <View style={{ flexDirection: 'row', }}>
                                        <Text style={styles.insideHeadText1}>Student Name</Text>
                                    </View>
                                ...
                                <View style={styles.commonView}>
                                    <View style={{ flexDirection: 'row', }}>
                                        <Text style={styles.insideHeadText1}>Father Name</Text>
                                    </View>
                                    <View style={{ backgroundColor: '#e9f1f2', width: wp('85%'), height: hp('6%'), borderRadius: 10 }}>
                                        <TextInput style={styles.inputStyle} onChangeText={Text => this.setState({ fathername: Text })}></TextInput>
                                    </View>
                                </View>
                                ...
                                <View style={styles.commonView}>
                                    ...
                                    <View style={{ backgroundColor: '#e9f1f2', width: wp('85%'), height: hp('6%'), borderRadius: 10 }}>
                                        ...
                                        <TextInput style={styles.inputStyle} onChangeText={Text => this.setState({ email: Text })}></TextInput>
                                    </View>
                                </View>
                                ...
                                <View style={styles.commonView}>
                                    <View style={{ flexDirection: 'row', }}>
                                        <Text style={styles.insideHeadText1}>Department</Text>
                                    </View>
                                    <View style={{ backgroundColor: '#e9f1f2', width: wp('85%'), height: hp('6%'), borderRadius: 10 }}>
                                        <Dropdown
                                ...
                                <View style={styles.commonView}>
                                    <View style={{ flexDirection: 'row', }}>
                                        <Text style={styles.insideHeadText}>Number of Section</Text>
                                    </View>
                                    <View style={{ backgroundColor: '#e9f1f2', width: wp('85%'), height: hp('6%'), borderRadius: 10 }}>

                                        <TextInput style={styles.inputStyle} onChangeText={Text => this.setState({ section: Text })}></TextInput>
                                    </View>
                                </View>

                                <View style={styles.commonView}>
                                    <View style={{ flexDirection: 'row', }}>
                                        <Text style={styles.insideHeadText}>Staff Name</Text>
                                    </View>
                                    <View style={{ backgroundColor: '#e9f1f2', width: wp('85%'), height: hp('6%'), borderRadius: 10 }}>

                                        <TextInput style={styles.inputStyle} onChangeText={Text => this.setState({ staffname: Text })}></TextInput>
                                    </View>
                                </View>

                                <View style={styles.commonView}>
                                    <View style={{ flexDirection: 'row', }}>
                                        <Text style={styles.insideHeadText}>Joining Date</Text>
                                    </View>
                                    <View style={{ backgroundColor: '#e9f1f2', width: wp('85%'), height: hp('6%'), borderRadius: 10 }}>

                                        <TextInput style={styles.inputStyle} placeholder="dd-mm-yyy" onChangeText={Text => this.setState({ joindate: Text })}></TextInput>
                                    </View>
                                </View>

                                <View style={styles.commonView}>
                                    <View style={{ flexDirection: 'row', }}>
                                        <Text style={styles.insideHeadText}>Tc Certificate</Text>
                                    </View>
                                    <View style={{ backgroundColor: 'white', width: wp('85%'), height: hp('6%'), borderRadius: 10, flexDirection: 'row' }}>
                                        <Image
                                            source={constant.file}
                                ...
                                <View style={styles.commonView}>
                                    <View style={{ flexDirection: 'row', }}>
                                        <Text style={styles.insideHeadText}>Aadhar Card</Text>
                                    </View>
                                    <View style={{ backgroundColor: '#e9f1f2', width: wp('85%'), height: hp('6%'), borderRadius: 10 }}>

                                        <TextInput style={styles.inputStyle}  onChangeText={Text => this.setState({ aadhar: Text })}></TextInput>
                                    </View>
                                </View>

                                <View style={{ marginTop: '3%', marginLeft: '4%' }}>
                                    <Text style={styles.insideHeadText2}>Address</Text>
                                    <TextInput style={styles.inputStyle1} multiline placeholderStyle={styles.placeholderStyle} onChangeText={Text => this.setState({ address: Text })}></TextInput>
                                </View>
...
const styles = StyleSheet.create({
    ...
    insideHeadText2: {
        fontWeight: "bold", fontSize: hp('2.2%'), color: '#1e6a78', marginTop: hp('.1%'), marginLeft: hp('1%')
    },
    bottomLine: {
