...
const staff = [
    ...
    { label: 'Vanitha', value: 'Vanitha' },
    { label: 'Parveen', value: 'Parveen' },
    { label: 'Ash', value: 'Ash' },
    { label: 'Ilakkiya', value: 'Ilakkiya' },
...
class DepartmentCreate extends Component {
    ...
    onCreateApi() {
        ...
        if (this.state.samplename == "") {
            alert('Please Enter Qulaification');
            return
        ...
        var raw = JSON.stringify({
          "course_name": this.state.samplename,
          "no_section": this.state.sampleType,
          "staff_name": this.state.description,
        });
        ...
        fetch("https://620502d5161670001741b2f7.mockapi.io/staff/department", requestOptions)
          .then(response => response.text())
          .then(result =>  this.props.navigation.navigate('CourseDetails'))
                    ...
                    <View style={{ backgroundColor: 'transparent', flex: 1, }}>
                        <ScrollView style={{ backgroundColor: constant.WHITE, padding: 5 }} keyboardShouldPersistTaps='handled'>
                            <View style={styles.container}>
                                <Text style={{ alignSelf: 'center', fontSize: hp('2%'), fontWeight: 'bold', color: '#1e6a78' }}>Add Department Details</Text>

                                <View style={styles.commonView}>
                                    <View style={{ flexDirection: 'row', }}>
                                        <Text style={styles.insideHeadText1}>Course Name</Text>
                                    </View>
