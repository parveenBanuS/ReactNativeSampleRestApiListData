                    ...
                    <View style={{ backgroundColor: 'transparent', }}>
                        <ScrollView style={{ backgroundColor: constant.WHITE, padding: 5 }} keyboardShouldPersistTaps='handled'>
                            ...
                            <View style={styles.container}>
                                ...
                                <View style={styles.commonView}>
                                    <Text style={styles.commonText}>Qualification</Text>
                                    <Text style={styles.commonSubText}>{this.state.useritem.qualification}</Text>
                                </View>

                                <View style={styles.commonView}>
                                    <Text style={styles.commonText}>Profile Image</Text>
                                    <Text style={styles.commonSubText}>{this.state.useritem.profile_image}</Text>
                                </View>

                                <View style={styles.commonView}>
                                    <Text style={styles.commonText}>Phone</Text>
                                    <Text style={styles.commonSubText}>{this.state.useritem.phone}</Text>
                                </View>
